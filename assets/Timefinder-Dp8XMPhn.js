import{u as y,h as j,r,j as t,d as v,x as S,y as N,z as w,p as L}from"./index-DuHMNxAT.js";import{B as C}from"./BackgroundScreen-DtiAunUV.js";import{L as z}from"./LockedOverlay-DnPlPD6J.js";function I(){try{const a=localStorage.getItem("profile_data")||localStorage.getItem("dev_profile_data")||localStorage.getItem("localProfile.v1");return a?JSON.parse(a):null}catch{return null}}function E(a){return a==="afternoon"?"afternoon":a==="evening"?"evening":a==="night"||a==="midnight"?"night":"morning"}function T(){const a=y(),n=j(),c=!!(n!=null&&n.isPremium),[m,u]=r.useState([]),[s,p]=r.useState(null),[g,x]=r.useState(!0),[d,f]=r.useState(!1);r.useEffect(()=>{async function i(){const e=I();e!=null&&e.dateOfBirth||new Date().toISOString().slice(0,10),E(e==null?void 0:e.timeRange),e!=null&&e.timeZoneId;const l=await N({location:e==null?void 0:e.country});if(l.ok&&l.data){const b=l.data.windows.map(o=>({id:o.id,hourLabel:o.title,description:o.description,keywords:o.shiChen.map(k=>k.key),isLocked:o.locked&&!c}));u(b)}x(!1)}i()},[c]);async function h(){if(!s||d)return;if(f(!0),(await w(s)).ok){L({requiresTimeSelection:!1}),a("/dashboard",{replace:!0});return}f(!1)}return g?t.jsx("div",{style:{background:"#0B0C2A",height:"100vh"}}):t.jsxs(C,{backgroundImage:v,className:"tf-screen",contentClassName:"tf-container",children:[t.jsx("style",{children:`
        .tf-screen {
