import{u as k,r as i,j as e,L as E,x as z,I as B}from"./index-DQfzOgci.js";import{b as I}from"./background_003-D8Gsq-oN.js";import{A as h}from"./AppShell-rTOyX860.js";import{E as $}from"./ErrorBox-lMib7A1M.js";import{B as m}from"./Button-CU5W_wks.js";import{P as b}from"./Popup-baljFIgx.js";import{u as A}from"./useSession-CDDD63iO.js";import"./profile_icon-DtzFR4rr.js";import"./exclamation_mark_icon-CRnSbbak.js";import"./question_mark_icon-PbVWcZNJ.js";function V(){var f;const c=k(),[l,j]=A(),[t,v]=i.useState([]),[y,S]=i.useState(!0),[x,g]=i.useState(null),[C,o]=i.useState(!1),[P,d]=i.useState(!1),[p,w]=i.useState(()=>localStorage.getItem("subscribed_plan_id")||""),u=!!(l!=null&&l.isPremium),r=i.useMemo(()=>p?t.find(a=>a.id===p)??t[0]:t.find(a=>a.id.includes("yearly"))??t[0],[p,t]);return i.useEffect(()=>{async function a(){var s;try{const n=await B();n.ok&&n.data?v(n.data.plans):g(((s=n.error)==null?void 0:s.message)||"Failed to load plans")}catch{g("An unexpected error occurred.")}finally{S(!1)}}a()},[]),y?e.jsx(h,{hideNav:!0,children:e.jsx(E,{label:"Loading plans..."})}):e.jsxs(h,{children:[e.jsx("style",{children:`
