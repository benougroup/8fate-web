import{u,dO as b,h as y,r,j as e,L as v,x as N,dP as w}from"./index-Cw7CMcbV.js";import{b as k}from"./background_003-D8Gsq-oN.js";import{i as Y}from"./back_page_icon-Dl_tVR_0.js";import{i as E,a as B,b as S}from"./yin_yang_balance-CnjywNEt.js";import{A as p}from"./AppShell-5tJr_IKL.js";import{B as D}from"./BackgroundScreen-tUfQpG5j.js";import{D as z}from"./DetailHeader-FLczhrpn.js";import{G as c}from"./GlassCard-DCNANTGB.js";import{L}from"./LockedOverlay-C--uxuvC.js";import{E as A}from"./ErrorBox-BXf8cYpJ.js";import"./profile_icon-DtzFR4rr.js";function $(){const o=u(),[h]=b(),g=y(),{isPremium:t}=g||{},l=h.get("key")||"balance",[s,f]=r.useState(null),[j,d]=r.useState(!0),[m,x]=r.useState(null);return r.useEffect(()=>{async function n(){var a;d(!0),x(null);try{const i=await w({key:l,detailLevel:t?"advanced":"beginner"});if(i.ok&&i.data)f(i.data);else throw new Error(((a=i.error)==null?void 0:a.message)||"Failed to load details")}catch(i){x((i==null?void 0:i.message)||"Something went wrong.")}finally{d(!1)}}n()},[l,t]),j?e.jsx(p,{children:e.jsx(v,{})}):e.jsxs(p,{children:[e.jsx("style",{children:`
        .yy-screen {
