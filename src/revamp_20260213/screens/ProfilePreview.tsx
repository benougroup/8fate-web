...
export function ProfilePreview() {
  ...
  async function handleLoad() {
    ...
    try {
      ...
      setLivingCountry(profile.livingCountry ?? "");
  ...
  async function handleSave() {
    ...
    const trimmedLivingCountry = livingCountry.trim();
    if (trimmedLivingCountry) {
      payload.livingCountry = trimmedLivingCountry;
    }
          ...
          <Stack gap="md">
            ...
            <PageSection>
              <Stack gap="sm" align="start">
                ...
                <label>
                  <Text>{t("profile.fields.livingCountry")}</Text>
                  <input
                    type="text"
                    value={livingCountry}
                    onChange={(event) => setLivingCountry(event.target.value)}
                  />
                </label>
                <label>
